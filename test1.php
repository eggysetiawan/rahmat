...
<body>
    ...
    <main class="mt-5 pt-5">
        ...
        <div class="container-fluid" style="">
            ...
            <!--Section: Jumbotron-->
            <section class="card rgba-teal-strong wow fadeIn" id="intro">
            ...
            <section class="pt-5">
                ...
                <div class="row wow fadeIn">
                    <div class="container-fluid" id="populasi">
                        <!--Grid column-->
                        <div class="pr1" style="overflow-x:auto;">
                            <h1 class="h1-responsive font-weight-bold text-center">Complete your 100 unit Dry Film Mission!</h1><br>
                            <center>
                                <h7>Get Free Mini PACS </h7>
                            </center>
                            <hr>
