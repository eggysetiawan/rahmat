...
session_start();
$no_penawaran = $_GET['penawaran_fk'];
...
INNER JOIN sales_order ON sales_funnel.penawaran_fk = sales_order.fk_penawaran
 WHERE penawaran_fk = '$no_penawaran' ");
				...
				<div class="row justify-content-md-center" style="margin: 0px;">
					...
					<div class="form-harian col-md-7">
						...
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<input type="hidden" class="form-control" id="pk" name="pk" value="<?= $row['pk']; ?>">
							<input type="hidden" class="form-control" id="no_penawaran" name="no_penawaran" value="<?= $no_penawaran; ?>">
							...
							<div class=" form-group">
								...
								<label>
									<input type="checkbox" id="mycheckbox4" name="kirim70" <?php if ($row['kirim70'] == '70%') echo 'checked' ?> value="70%"> Tanggal Kirim
								</label><br>
								...
								<label>
									<input type="checkbox" id="mycheckbox3" name="kirim100" <?php if ($row['kirim100'] == '100%') echo 'checked'; ?> value="100%">Tanggal Terima Resi
								</label><br>
