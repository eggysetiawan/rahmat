					...
					<div class="form-row">
						<div class="col-1">
							...
							<select class="form-control" id="from" name="from">
								...
								<?php
								$resTahun = mysqli_query($conn, "SELECT tahun_targeting FROM sales_targeting GROUP BY tahun_targeting");
								?>
				...
				<div class="justify-content-md-center" id="purchase_order">
					...
					<div class="col-md-12 table-box" style="overflow-x:auto;">
						...
						<div>
							...
							<h3>
								<a href="printTargeting.php" class="btn btn-primary">Report Print</a>
							</h3>
						</div>
