...
<div class="jumbotron card card-image"
            style=" width: 100%; background-size: cover; min-height: 563px; padding: 1rem 2rem; background-image: url(../image/back.png);">
            <div class="text-white">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h2 class="card-title h1-responsive pt-3 mb-5 font-bold"><strong>Selamat Datang di Portal
                                    Sales
                                    Intimedika</strong>
                            </h2><br>  
                        </div>
    ...
    <div class="col-md-3">
      ...
      <div class="card" style="height: 500px; overflow-y: auto;">
        ...
        <div class="card-body">
          ...
          <!-- Text -->
          <p class="card-text">Silver halide based X-ray film Universal, environmental friendly developers..</p>
          <!-- Button -->
    ...
    <div class="col-md-3">
      ...
      <div class="card" style="height: 500px; overflow-y: auto;">
        ...
        <div class="card-body">
          ...
          <!-- Text -->
          <p class="card-text">High frequency mobile X-Ray System, Powerful output covering most...</p>
          <!-- Button -->
