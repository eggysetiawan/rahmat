...
WHERE tujuan_funnel = 'sales' AND delete_funnel = 'ada' AND tahun_funnel IN ('" . $_POST["from"] . "')
AND sales_funnel.username = '$username2'
 GROUP BY pk ORDER BY pk ASC");
	...
	AND tahun_funnel IN ('" . $_POST["from"] . "') ");
                ...
                <table class="table_kunjungan" style="margin-top: 0px;" border="1" cellpadding="8" cellspacing="0">
                    ...
                    <tr>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) : ?>
                            ...
                            <td><?php echo $row['status_funnel']; ?><a href="#" class="edit-record" data-id="<?= $row['pk'];  ?>"></td>
