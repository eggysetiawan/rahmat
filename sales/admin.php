...
INNER JOIN inti_rs ON sales_customer.fk_rs = inti_rs.pk_rs
 WHERE username = '$username' ORDER BY pk_cust ASC");
							...
							<?php } else { ?>
								<tr>
									...
									while ($row = mysqli_fetch_assoc($result)) : ?>
										...
										<td><a href="edit_cust.php?pk_cust=<?= $row['pk_cust']; ?>"><button class="btn btn-fnl btn-primary" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a></td>
