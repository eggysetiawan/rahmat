            ...
            <div class="container-fluid content1">
                <div class="row justify-content-md-center" style="margin: 0px;">
                    ...
                    <div class="form-harian col-md-6">
                        ...
                        <form action="penawaran.php" method="post">
                            <div class="form-group">
                                <!-- <label for="count_add">Masukan Form Penawaran Modality yang diiginkan (Max 4 Penawaran)</label> -->
                                <input type="text" class="form-control" id="count_add" name="count_add" placeholder="masukan jumlah modality yang ingin ditambahkan" required maxlength="1" pattern="[1-9]+">
